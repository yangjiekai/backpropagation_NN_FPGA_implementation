...
module mu (
	...
	mu_altfp_mult_41o	mu_altfp_mult_41o_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL mu.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mu.cmp FALSE TRUE
